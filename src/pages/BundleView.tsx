  ...
  return <motion.div initial={{
    ...
    y: 0
      ...
      <div className="container mx-auto max-w-[1400px] px-4 py-8">
          ...
          <nav className="flex justify-center">
            <div className="bg-card rounded-full p-1 shadow-lg">
              <div className="flex space-x-1">
                ...
                return <Button key={tab.id} variant={isActive ? "default" : "ghost"} className={cn("rounded-full px-6 py-2 transition-all duration-200", isActive ? "shadow-sm" : "hover:bg-accent/50")} onClick={() => navigate(`/dashboard/bundle/${bundleId}/${tab.path}`)}>
        ...
        <div className="w-full min-h-[calc(100vh-300px)] pt-4 px-[240px]">
          <Routes>
