...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background w-full">
      {/* Navigation */}
      <nav className="w-full px-4 py-4 flex justify-end">
      ...
      {/* Hero Section */}
      <section className="w-full flex flex-col items-center justify-center min-h-[70vh] px-4 py-12">
        <motion.div 
      ...
      {/* Features Section */}
      <section className="w-full bg-accent/20 py-12 md:py-24">
